...
describe("EqHistColorMapper module", () => {
  ...
  describe("EqHistColorMapper.scan method", () => {
    ...
    function scan_check(values: number[], expected_binning: number[], rescale_discrete_levels: boolean = false, low_cutoff_index: number = 0) {
    ...
    it("Should scan using rescale_discrete_levels", () => {
      ...
      scan_check(values, [1, 10.305641, 100], true, 1)
    })
  })
})
